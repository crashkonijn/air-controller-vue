(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["air-controller"] = factory(require("vue"));
	else
		root["air-controller"] = factory(root["Vue"]);
...
/* harmony default export */ var store = (new vuex_esm.Store({
  state: {
    airConsole: {
      ...
      message: function message(target, data) {
        console.log(data);
      },
      onDeviceMotion: null
    },
  ...
  mutations: {
    showPage: function showPage(state, page) {
      state.currentPage = page;
    },
    setAirConsole: function setAirConsole(state, airConsole) {
      state.airConsole = airConsole;
    },
    setDeviceData: function setDeviceData(state, data) {
      var deviceData = lodash_default.a.get(data, state.deviceId);
      ...
      if (deviceData) {
        ...
        lodash_default.a.forOwn(deviceData.customdata, function (value, key) {
          external_commonjs_vue_commonjs2_vue_root_Vue_default.a.set(state.deviceData.customData, key, value);
        });

        event_bus.$emit('onData', state.deviceData.customData);
        this.commit('setPage', deviceData.view);
      }
    },
    setDeviceId: function setDeviceId(state, id) {
      state.deviceId = id;
    },
    sendMessage: function sendMessage(state, payload) {
      ...
      lodash_default.a.set(state.input, key, payload);

      event_bus.$emit('sendMessage');
    },
    clearInput: function clearInput(state, lastSend) {
      lodash_default.a.forEach(lastSend, function (value, key) {
        if (lodash_default.a.get(state.channelSettings, key) === 'continues') {
          lodash_default.a.set(state.lastSend, key, value);
        }
      });
    ...
    setPage: function setPage(state, view) {
      if (state.deviceData.view !== view) {
        state.deviceData.view = view;
        event_bus.$emit('onShowPage', view);
      }
    },
    setIsPremium: function setIsPremium(state, premium) {
      state.isPremium = premium;
      event_bus.$emit('onBecamePremium', premium);
    },
    addAxis: function addAxis(state, object) {
      lodash_default.a.set(state.axis, object.key + '.id' + object.id, object.value);

      event_bus.$emit('sendMessage');
    },
    removeAxis: function removeAxis(state, object) {
      lodash_default.a.set(state.axis, object.key + '.id' + object.id, new victor_default.a(0, 0));

      event_bus.$emit('sendMessage');
    },
    setChannelSetting: function setChannelSetting(state, payload) {
      lodash_default.a.set(state.channelSettings, payload.name, payload.channel);
    }
  },
  getters: {
    airConsole: function airConsole(state) {
      return state.airConsole;
    },
    deviceId: function deviceId(state) {
      return state.deviceId;
    },
    deviceData: function deviceData(state) {
      return state.deviceData;
    },
    currentPage: function currentPage(state) {
      return state.deviceData.view.toLowerCase();
    },
    deviceClasses: function deviceClasses(state) {
      return state.deviceData.class;
    },
    isPremium: function isPremium(state) {
      return state.isPremium;
    },
    getCustomData: function getCustomData(state) {
      return function (key) {
        if (!lodash_default.a.has(state.deviceData.customData, key)) {
          external_commonjs_vue_commonjs2_vue_root_Vue_default.a.set(state.deviceData.customData, key, null);
        }

        return state.deviceData.customData[key];
      };
    },
    getInput: function getInput(state) {
      return state.input;
    },
    getAxis: function getAxis(state) {
      return state.axis;
    },
    getLastSend: function getLastSend(state) {
      return state.lastSend;
    },
    getChannelSettings: function getChannelSettings(state) {
      return state.channelSettings;
    }
  }
}));
// EXTERNAL MODULE: ./node_modules/vue2-hammer/index.min.js
var index_min = __webpack_require__("6591");
...
/* harmony default export */ var helpers = ({
  install: function install(Vue) {
    Vue.prototype.camel_case = function (string) {
      return string ? this.studly_case(string).replace(/^\w/, function (c) {
    ...
    Vue.prototype.title_case = function (string) {
      return string ? this.space_case(string).replace(/^\w|\W\w/g, function (c) {
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"d1b3d832-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Axis.vue?vue&type=template&id=1d0741f0&xmlns%3Av-hammer=http%3A%2F%2Fwww.w3.org%2F1999%2Fxhtml&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('button',{directives:[{name:"hammer",rawName:"v-hammer:press",value:(_vm.press),expression:"press",arg:"press"},{name:"hammer",rawName:"v-hammer:pressup",value:(_vm.pressUp),expression:"pressUp",arg:"pressup"},{name:"hammer",rawName:"v-hammer:pan.end",value:(_vm.panEnd),expression:"panEnd",arg:"pan",modifiers:{"end":true}}],class:_vm.classes},[_vm._t("default",[_vm._v(_vm._s(_vm.id || _vm.name)+": "+_vm._s(_vm.mode))])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Axis.vue?vue&type=template&id=1d0741f0&xmlns%3Av-hammer=http%3A%2F%2Fwww.w3.org%2F1999%2Fxhtml&
...
// CONCATENATED MODULE: ./src/mixins/anchor.js
  ...
  props: {
    anchor: {
      ...
      validator: function validator(val) {
        return ['top-left', 'top-center', 'top-right', 'center-left', 'center-center', 'center-right', 'bottom-left', 'bottom-center', 'bottom-right'].includes(val);
      }
    }
  },
  computed: {
...
// CONCATENATED MODULE: ./src/mixins/base.js
...
var base = {
  ...
  computed: {
    baseClasses: function baseClasses() {
      var component = this.kebab_case(this.$options.name);
...
// CONCATENATED MODULE: ./src/mixins/premium.js
...
var premium_premium = {
  ...
  computed: _objectSpread({}, mapGetters(['isPremium', 'airConsole']), {
    premiumClasses: function premiumClasses() {
      if (this.premiumOnly) {
        if (this.isPremium) {
          return 'premium-only';
        }
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Axis.vue?vue&type=script&lang=js&
...
/* harmony default export */ var Axisvue_type_script_lang_js_ = ({
  name: 'AirAxis',
  mixins: [base, anchor_anchor, premium_premium],
  props: {
    mode: {
      required: true,
      validator: function validator(val) {
        return ['left', 'up-left', 'up', 'up-right', 'right', 'down-right', 'down', 'down-left', 'custom'].includes(val);
      }
    },
    value: {
      required: false,
      default: function _default() {
        return new victor_default.a(0, 0);
      }
    }
  },
  data: function data() {
  ...
  computed: {
    ...
    pressedClasses: function pressedClasses() {
      if (!this.isPressed) {
        return '';
      }
    ...
    vectors: function vectors() {
      return {
        'left': new victor_default.a(-1, 0),
        'up-left': new victor_default.a(-1, 1),
        'up': new victor_default.a(0, 1),
        'up-right': new victor_default.a(1, 1),
        'right': new victor_default.a(1, 0),
        'down-right': new victor_default.a(1, -1),
        'down': new victor_default.a(0, -1),
        'down-left': new victor_default.a(-1, -1),
        'custom': this.value
      };
    },
    currentVector: function currentVector() {
      return lodash_default.a.get(this.vectors, this.mode, new victor_default.a(0, 0));
    }
  },
  methods: {
...
// CONCATENATED MODULE: ./src/components/Axis.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_Axisvue_type_script_lang_js_ = (Axisvue_type_script_lang_js_); 
...
var component = normalizeComponent(
  components_Axisvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var Buttonvue_type_script_lang_js_ = ({
  ...
  props: {
    mode: {
      ...
      type: String,
      validator: function validator(val) {
        return ['down', 'hold', 'tap', 'double-tap'].includes(val);
      }
    },
    value: {
      required: false,
...
// CONCATENATED MODULE: ./src/mixins/sender.js
...
var sender = {
  mounted: function mounted() {
    ...
    lodash_default.a.set(this.channels, 'default', lodash_default.a.debounce(function () {
      _this.sendMessage();
    }, 110, {
      leading: true,
      trailing: false
    ...
    lodash_default.a.set(this.channels, 'continues', lodash_default.a.debounce(function () {
      _this.sendMessage();
    }, 200, {
      leading: true,
      trailing: false
    ...
    event_bus.$on('sendMessage', this.onSendMessage);
  },
  data: function data() {
    return {
      channels: {}
  ...
  methods: {
    onSendMessage: function onSendMessage() {
      ...
      lodash_default.a.each(this.getChannels(this.collectData()), function (inputs, key) {
        lodash_default.a.get(_this2.channels, key)();
      });
    },
    ...
    collectData: function collectData() {
      ...
      var data = assign_default()({}, this.getInput);

      lodash_default.a.forEach(this.getAxis, function (value, key) {
        lodash_default.a.set(data, key, _this3.compileAxis(value));
      });

      var filtered = {};

      lodash_default.a.forEach(data, function (value, key) {
        if (!lodash_default.a.isEqual(value, lodash_default.a.get(_this3.getLastSend, key))) {
          lodash_default.a.set(filtered, key, value);
        }
      });

      return filtered;
    },
    cancelChannels: function cancelChannels() {
      lodash_default.a.each(this.channels, function (value) {
        value.cancel();
      });
    },
    getChannels: function getChannels(data) {
      ...
      return lodash_default.a.groupBy(lodash_default.a.keys(data), function (key) {
        return lodash_default.a.get(_this4.getChannelSettings, key, 'default');
      });
    },
    compileAxis: function compileAxis(data) {
      var v = new victor_default.a(0, 0);

      lodash_default.a.forEach(data, function (value) {
        v.add(value);
      });

      return {
        type: 'vector',
        value: v.divideScalar(keys_default()(data).length)
      };
    }
  }
};
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Controller.vue?vue&type=script&lang=js&
...
/* harmony default export */ var Controllervue_type_script_lang_js_ = ({
  name: 'AirController',
  mixins: [sender],
  mounted: function mounted() {
    this.initAirConsole();
  ...
  computed: _objectSpread({}, mapGetters(['airConsole', 'deviceId', 'currentPage', 'deviceClasses', 'getInput', 'getAxis', 'getLastSend', 'getChannelSettings'])),
  methods: {
    initAirConsole: function initAirConsole() {
...
// CONCATENATED MODULE: ./src/components/Controller.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_Controllervue_type_script_lang_js_ = (Controllervue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/components/Controller.vue
...
/* harmony default export */ var Controller = (Controller_component.exports);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"d1b3d832-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Gyroscope.vue?vue&type=template&id=201155b7&
var Gyroscopevue_type_template_id_201155b7_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._t("default")],2)}
var Gyroscopevue_type_template_id_201155b7_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Gyroscope.vue?vue&type=template&id=201155b7&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Gyroscope.vue?vue&type=script&lang=js&
...
/* harmony default export */ var Gyroscopevue_type_script_lang_js_ = ({
  name: 'AirGyroscope',
  mounted: function mounted() {
  ...
  computed: _objectSpread({}, mapGetters(['airConsole'])),
  methods: {
    onDeviceMotion: function onDeviceMotion(data) {
      this.$store.commit('sendMessage', {
        type: 'gyro',
        value: data,
        key: 'motion'
...
// CONCATENATED MODULE: ./src/components/Gyroscope.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_Gyroscopevue_type_script_lang_js_ = (Gyroscopevue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/components/Gyroscope.vue
...
var Gyroscope_component = normalizeComponent(
  components_Gyroscopevue_type_script_lang_js_,
  Gyroscopevue_type_template_id_201155b7_render,
  Gyroscopevue_type_template_id_201155b7_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var Dragstickvue_type_script_lang_js_ = ({
  name: 'AirJoystick',
  mixins: [base, anchor_anchor, premium_premium],
  mounted: function mounted() {
  ...
  methods: {
    ...
    getVictor: function getVictor(e) {
      return new victor_default.a(e.center.x, e.center.y);
    },
    updateJoystickPosition: function updateJoystickPosition() {
      if (this.dragPosition.distance(this.joystickPosition) > 50) {
        var dir = this.dragPosition.clone().subtract(this.joystickPosition);
        this.joystickPosition = this.dragPosition.clone().subtract(dir.normalize().multiply(new victor_default.a(50, 50)));
      }
    }
  }
});
// CONCATENATED MODULE: ./src/components/Dragstick.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_Dragstickvue_type_script_lang_js_ = (Dragstickvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/components/Dragstick.vue
...
/* harmony default export */ var Dragstick = (Dragstick_component.exports);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"d1b3d832-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Joystick.vue?vue&type=template&id=3a3cccb2&
var Joystickvue_type_template_id_3a3cccb2_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"joystick",class:_vm.classes},[_c('div',{staticClass:"children"},[_vm._t("default")],2)])}
var Joystickvue_type_template_id_3a3cccb2_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Joystick.vue?vue&type=template&id=3a3cccb2&

// EXTERNAL MODULE: ./node_modules/nipplejs/dist/nipplejs.js
var nipplejs = __webpack_require__("caaf");
var nipplejs_default = /*#__PURE__*/__webpack_require__.n(nipplejs);

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Joystick.vue?vue&type=script&lang=js&
...
/* harmony default export */ var Joystickvue_type_script_lang_js_ = ({
  name: 'AirJoystick',
  mixins: [base, anchor_anchor, premium_premium],
  mounted: function mounted() {
    var _this = this;
    ...
    this.$nextTick(function () {
      nipplejs_default.a.create({
        zone: _this.$refs.joystick,
        color: 'blue'
      }).on('added', function (evt, nipple) {
        _this.joystick = nipple;
        nipple.on('move', _this.move);
        nipple.on('end', _this.end);
      });
    });
    this.$store.commit('setChannelSetting', {
      name: this.name,
  ...
  methods: {
    getAngle: function getAngle() {
      var pos = new victor_default.a(this.joystick.position.x, this.joystick.position.y * -1);
      var target = new victor_default.a(this.joystick.frontPosition.x, this.joystick.frontPosition.y * -1).add(pos);
...
// CONCATENATED MODULE: ./src/components/Joystick.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_Joystickvue_type_script_lang_js_ = (Joystickvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/components/Joystick.vue
...
var Joystick_component = normalizeComponent(
  components_Joystickvue_type_script_lang_js_,
  Joystickvue_type_template_id_3a3cccb2_render,
  Joystickvue_type_template_id_3a3cccb2_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var Joystick = (Joystick_component.exports);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"d1b3d832-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Page.vue?vue&type=template&id=3891eb74&
var Pagevue_type_template_id_3891eb74_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.isCurrentPage)?_c('div',{class:_vm.classes},[_c('div',{staticClass:"children"},[_vm._t("default")],2)]):_vm._e()}
var Pagevue_type_template_id_3891eb74_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Page.vue?vue&type=template&id=3891eb74&
...
/* harmony default export */ var Pagevue_type_script_lang_js_ = ({
  name: 'AirPage',
  mixins: [base],
  computed: _objectSpread({}, mapGetters(['currentPage']), {
...
var Page_component = normalizeComponent(
  ...
  Pagevue_type_template_id_3891eb74_render,
  Pagevue_type_template_id_3891eb74_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"d1b3d832-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Pan.vue?vue&type=template&id=530c67ca&
var Panvue_type_template_id_530c67ca_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"hammer",rawName:"v-hammer:pan.all.end",value:(_vm.pan),expression:"pan",arg:"pan",modifiers:{"all":true,"end":true}}],ref:"area",class:_vm.classes},[_vm._t("default")],2)}
var Panvue_type_template_id_530c67ca_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Pan.vue?vue&type=template&id=530c67ca&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Pan.vue?vue&type=script&lang=js&
...
/* harmony default export */ var Panvue_type_script_lang_js_ = ({
  ...
  methods: {
    pan: function pan(e) {
      var vector = new victor_default.a(e.deltaX, e.deltaY * -1);
      var length = 10 / this.$refs.area.clientWidth * vector.length();
      this.$store.commit('sendMessage', {
        type: 'pan',
        value: {
...
// CONCATENATED MODULE: ./src/components/Pan.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_Panvue_type_script_lang_js_ = (Panvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/components/Pan.vue
...
var Pan_component = normalizeComponent(
  ...
  Panvue_type_template_id_530c67ca_render,
  Panvue_type_template_id_530c67ca_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"d1b3d832-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Position.vue?vue&type=template&id=135a380f&
var Positionvue_type_template_id_135a380f_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:_vm.classes},[_c('div',{staticClass:"children"},[_vm._t("default")],2)])}
var Positionvue_type_template_id_135a380f_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Position.vue?vue&type=template&id=135a380f&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Position.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var Positionvue_type_script_lang_js_ = ({
  name: 'AirPosition',
  mixins: [anchor_anchor],
  computed: {
    classes: function classes() {
      return ['air-position', this.anchorClasses].join(' ');
    }
  }
});
// CONCATENATED MODULE: ./src/components/Position.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_Positionvue_type_script_lang_js_ = (Positionvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/components/Position.vue
...
var Position_component = normalizeComponent(
  components_Positionvue_type_script_lang_js_,
  Positionvue_type_template_id_135a380f_render,
  Positionvue_type_template_id_135a380f_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"d1b3d832-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/ProfileImage.vue?vue&type=template&id=3013e853&
var ProfileImagevue_type_template_id_3013e853_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:_vm.classes,style:('backgroundImage: url(' + _vm.image + ')')},[_vm._t("default")],2)}
var ProfileImagevue_type_template_id_3013e853_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/ProfileImage.vue?vue&type=template&id=3013e853&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/ProfileImage.vue?vue&type=script&lang=js&
...
/* harmony default export */ var ProfileImagevue_type_script_lang_js_ = ({
  ...
  computed: _objectSpread({}, mapGetters(['airConsole', 'deviceId']), {
    classes: function classes() {
      return [this.baseClasses, this.anchorClasses].join(' ');
    },
...
// CONCATENATED MODULE: ./src/components/ProfileImage.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_ProfileImagevue_type_script_lang_js_ = (ProfileImagevue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/components/ProfileImage.vue
...
var ProfileImage_component = normalizeComponent(
  components_ProfileImagevue_type_script_lang_js_,
  ProfileImagevue_type_template_id_3013e853_render,
  ProfileImagevue_type_template_id_3013e853_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var ProfileImage = (ProfileImage_component.exports);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"d1b3d832-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Swipe.vue?vue&type=template&id=30eecf2b&
var Swipevue_type_template_id_30eecf2b_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"hammer",rawName:"v-hammer:swipe.all",value:(_vm.swipe),expression:"swipe",arg:"swipe",modifiers:{"all":true}}],class:_vm.classes},[_vm._t("default")],2)}
var Swipevue_type_template_id_30eecf2b_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Swipe.vue?vue&type=template&id=30eecf2b&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Swipe.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./src/components/Swipe.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_Swipevue_type_script_lang_js_ = (Swipevue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/components/Swipe.vue
...
var Swipe_component = normalizeComponent(
  components_Swipevue_type_script_lang_js_,
  Swipevue_type_template_id_30eecf2b_render,
  Swipevue_type_template_id_30eecf2b_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"d1b3d832-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Data.vue?vue&type=template&id=4fa341a8&
var Datavue_type_template_id_4fa341a8_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:_vm.classes},[_vm._v("\n    "+_vm._s(_vm.data)+"\n")])}
var Datavue_type_template_id_4fa341a8_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Data.vue?vue&type=template&id=4fa341a8&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Data.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var Datavue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    data: function data() {
      return this.$store.getters.getCustomData(this.key);
    }
  }
});
// CONCATENATED MODULE: ./src/components/Data.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_Datavue_type_script_lang_js_ = (Datavue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/components/Data.vue
...
var Data_component = normalizeComponent(
  components_Datavue_type_script_lang_js_,
  Datavue_type_template_id_4fa341a8_render,
  Datavue_type_template_id_4fa341a8_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var components = ({
  install: function install(Vue) {
    Vue.component('air-axis', Axis);
    Vue.component('air-button', Button);
    Vue.component('air-controller', Controller);
    Vue.component('air-gyroscope', Gyroscope);
    Vue.component('air-dragstick', Dragstick);
    Vue.component('air-joystick', Joystick);
    Vue.component('air-page', Page);
    Vue.component('air-pan', Pan);
    Vue.component('air-position', Position);
    Vue.component('air-profile-image', ProfileImage);
    Vue.component('air-swipe', Swipe);
    Vue.component('air-data', Data);
  }
});
...
index_min["VueHammer"].config.press = {
  time: 1
};
/* harmony default export */ var src = ({
  install: function install(Vue) {
    Vue.use(index_min["VueHammer"]);
    Vue.use(helpers);
    Vue.use(components);
  }
});
// EXTERNAL MODULE: ./src/styles/air-controller.scss
var air_controller = __webpack_require__("4762");
...
//# sourceMappingURL=air-controller.umd.js.map